...
public class LicenseWebExceptionHandler {
     ...
     */
    @ExceptionHandler(value = LicenseWebException.class)
    public ResponseVO licenseWebExceptionHandler(LicenseWebException e) {
        log.error("licenseWebExceptionHandler  {}", ExceptionUtil.stacktraceToString(e));
    ...
    public ResponseVO defaultErrorHandler(Exception e) {
        ...
        if (e.getCause() instanceof LicenseWebException) {
            licenseWebExceptionHandler((LicenseWebException) e);
        }
